...
export class RegisterComponent {
  ...
  hobbies:string[]=['dancing','singing','acting','sketching'];
  
  colors:ChipColor[]=
  [
    {name:'dancing',color:undefined},
    {name:'singing',color:'primary'},
    {name:'acting',color:'warn'},
    {name:'sketching',color:'accent'}
  ]
  empform!:FormGroup;
